...
impl fmt::Display for FieldType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Self::Mac(value) => write!(f, "{}", mac_str(value)),
...
impl Field {
    fn to_json(&self) -> Value {
        match self.field.clone() {
            ...
            FieldType::Mac(value) => json!(mac_str(&value)),
        }
    }
}
...
pub fn get_field_type(field_id: u32, value: usize) -> Option<FieldType> {
    match field_id {
        ...
        fields::ETH_DST_MAC | fields::ETH_SRC_MAC => Some(FieldType::Mac(value as u64)),
