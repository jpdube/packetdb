...
impl UdpFrame {
    ...
    pub fn length(&self) -> u16 {
        BigEndian::read_u16(&self.raw_packet[self.start + 4..self.start + 6])
    }

    pub fn checksum(&self) -> u16 {
        BigEndian::read_u16(&self.raw_packet[self.start + 6..self.start + 8])
    }

    pub fn _payload(&self) -> Vec<u8> {
        self.raw_packet[self.start + 8..self.end].to_vec()
    }
